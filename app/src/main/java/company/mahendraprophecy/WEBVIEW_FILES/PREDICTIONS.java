...
public class PREDICTIONS extends ActionBarActivity {
    WebView webView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        builder.scheme("http")
                ...
                .appendPath("v1")
                .appendPath("page.php")
                .appendQueryParameter("q", "predictions")
        ...
        webView.setWebViewClient(new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
                // do your stuff here
                ((ProgressWheel)findViewById(R.id.predictions_progress_wheel)).setVisibility(View.INVISIBLE);
